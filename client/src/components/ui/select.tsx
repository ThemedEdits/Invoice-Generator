...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      // colors
      "border border-[1.5px] border-white/[0.08] bg-white/[0.04] text-white",
      "data-[placeholder]:text-slate-500",
      // hover
      "hover:border-white/[0.15] hover:bg-white/[0.06]",
      // focus — border only, no ring/shadow
      "focus:outline-none focus:border-[1.5px] focus:border-amber-400/60 focus:bg-amber-400/5",
      // transition
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // dark glass styling
        "border border-white/[0.08] bg-[#1a1d24] text-white",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-[10px] font-bold uppercase tracking-widest text-slate-500",
      className
    )}
    {...props}
  />
